...
FROM docker.cloudsmith.io/${CLOUDSMITH_WORKSPACE}/${CLOUDSMITH_REPOSITORY}/node:26-alpine3.24-dev AS dev
...
FROM docker.cloudsmith.io/${CLOUDSMITH_WORKSPACE}/${CLOUDSMITH_REPOSITORY}/node:26-alpine3.24-dev
# DHI (Docker Hardened Images)
# dhi.io/node:26-alpine-dev
